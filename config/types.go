...
type ServiceConfig struct {
	...
	CPUShares          yaml.StringorInt     `yaml:"cpu_shares,omitempty"`
	CPUQuota           yaml.StringorInt     `yaml:"cpu_quota,omitempty"`
	CPUPercent         yaml.StringorInt     `yaml:"cpu_percent,omitempty"` //hack add CPUPercent, CPURealtimePeriod and  CPURealtimeRuntime
	CPURealtimePeriod  yaml.StringorInt     `yaml:"cpu_rt_period,omitempty"`
	CPURealtimeRuntime yaml.StringorInt     `yaml:"cpu_rt_runtime,omitempty"`
	Command            yaml.Command         `yaml:"command,flow,omitempty"`
	CgroupParent       string               `yaml:"cgroup_parent,omitempty"`
	ContainerName      string               `yaml:"container_name,omitempty"`
	Devices            []string             `yaml:"devices,omitempty"`
